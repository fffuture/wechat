<template>
	<footer class="color-gray">
			<router-link to="/slides/message" replace tag="div"  class="swiper-pagination-bullet">
				<!--<i class="fa fa-comment-o"></i>-->
				<!--<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 800 800" preserveAspectRatio="xMidYMid meet">
				...
				<g id="layer103" fill="#fcfcfc" stroke="none">
				 ...
				 <path d="M325 616 c-23 -7 -49 -17 -60 -23 -14 -8 -29 -7 -58 3 -22 8 -42 12 -44 10 -3 -2 3 -18 11 -35 16 -30 15 -32 -9 -70 -17 -25 -28 -59 -32 -95 -8 -77 15 -133 76 -188 115 -104 307 -104 422 0 60 53 83 110 77 186 -13 157 -210 266 -383 212z"/>
				 </g>

				</svg>-->
				<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 800 800" preserveAspectRatio="xMidYMid meet">
				<g id="layer101" fill="#46c01b" stroke="none">
				 <path d="M0 400 l0 -400 400 0 400 0 0 400 0 400 -400 0 -400 0 0 -400z"/>
				 </g>
				<g id="layer102" fill="#b1b1b1" stroke="none">
				 <path d="M0 400 l0 -400 400 0 400 0 0 400 0 400 -400 0 -400 0 0 -400z m177 236 c51 -17 55 -17 113 3 161 56 334 3 417 -126 31 -48 35 -63 36 -121 1 -99 -45 -180 -134 -234 -118 -73 -303 -65 -402 16 -108 89 -141 217 -82 324 25 47 27 53 13 74 -24 38 -40 91 -25 85 6 -2 36 -12 64 -21z"/>
				...
				<g id="layer103" fill="#fcfcfc" stroke="none">
				 <path d="M0 400 l0 -400 400 0 400 0 0 400 0 400 -400 0 -400 0 0 -400z m555 244 c66 -23 166 -121 183 -180 45 -154 -48 -300 -222 -350 -220 -62 -450 104 -422 304 3 25 15 63 26 84 25 48 25 50 -5 109 -29 58 -23 61 68 30 51 -18 59 -18 86 -5 73 36 193 40 286 8z"/>
				 <path fill="#46c01b" d="M325 616 c-23 -7 -49 -17 -60 -23 -14 -8 -29 -7 -58 3 -22 8 -42 12 -44 10 -3 -2 3 -18 11 -35 16 -30 15 -32 -9 -70 -17 -25 -28 -59 -32 -95 -8 -77 15 -133 76 -188 115 -104 307 -104 422 0 60 53 83 110 77 186 -13 157 -210 266 -383 212z"/>
				 </g>

				</svg>
				<span>微信</span>
			</router-link>
			<router-link to="/slides/contact" replace tag="div">
				...
				<g id="layer103" fill="#fbfbfb" stroke="none">
				 ...
				 <path d="M130 631 c0 -5 42 -35 93 -67 50 -31 98 -64 105 -73 20 -25 14 -63 -17 -96 -82 -85 -41 -245 63 -245 108 0 147 173 57 254 -13 12 -21 31 -21 53 0 31 6 37 77 81 42 26 90 59 107 74 l31 27 -247 1 c-143 0 -248 -4 -248 -9z"/>
				 </g>

				</svg>
				<span>通讯录</span>
			</router-link>
			<router-link to="/slides/discovery" replace tag="div">
				<!--<i class="activity fa fa-compass"></i>-->
				<!--<i class="fa fa-compass activity"></i>-->
				<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1.8rem" height="1.8rem" viewBox="0 0 800 800" preserveAspectRatio="xMidYMid meet">
				<g id="layer101" fill="#999999" stroke="none">
				 <path d="M0 400 l0 -400 400 0 400 0 0 400 0 400 -400 0 -400 0 0 -400z"/>
				 </g>
				...
				<g id="layer103" fill="#fcfcfc" stroke="none">
				 ...
				 <path d="M329 667 c-120 -45 -189 -137 -190 -252 -1 -82 25 -148 82 -205 171 -171 465 -43 461 200 -3 143 -113 257 -256 266 -36 3 -75 -1 -97 -9z m129 -210 c12 -10 112 -199 112 -212 0 -10 -195 93 -211 111 -14 16 -109 196 -109 207 0 5 193 -93 208 -106z"/>
				 <path d="M384 415 c-4 -9 -2 -21 4 -27 16 -16 47 -5 47 17 0 26 -42 34 -51 10z"/>
				 </g>
			...
			<router-link to="/slides/mine" replace tag="div">
				...
				<g id="layer103" fill="#fcfcfc" stroke="none">
				 ...
				 <path  d="M170 620 c0 -6 35 -32 78 -59 122 -78 122 -77 122 -120 0 -27 -7 -44 -25 -61 -81 -77 -37 -240 66 -240 30 0 43 7 67 35 54 61 52 153 -3 205 -18 17 -25 34 -25 61 0 43 0 42 123 120 42 27 77 53 77 59 0 6 -85 10 -240 10 -155 0 -240 -4 -240 -10z"/>
				 </g>
